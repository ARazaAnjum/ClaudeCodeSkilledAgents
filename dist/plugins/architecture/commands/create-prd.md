...
Generate a detailed PRD in Markdown format for the feature described in: $ARGUMENTS

## Process

1. **Receive Initial Prompt:** The user provides a brief description or request for a new feature or functionality.
2. **Ask Clarifying Questions:** Before writing the PRD, you _must_ ask clarifying questions to gather sufficient detail. The goal is to understand the "what" and "why" of the feature, not the "how". Provide options in letter/number lists so the user can respond easily with their selections.
